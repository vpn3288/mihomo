...
// Clash Verge Rev subscription script v2.5 (链式代理版)
// 分流策略：
...
function validateSubscriptions() {
  var keys = ["Front", "Edge", "Chrome", "Firefox", "Brave", "LibreWolf", "Vivaldi", "Opera", "Default"];
  var i;
...
function buildGroups() {
  ...
  groups.push(makeUrlTestGroup("FrontAuto", "provider-front"));
  groups.push({
    name: "FrontProxy",
    type: "select",
    proxies: ["FrontAuto"],
