...
// Clash Verge Rev subscription script v2.6 (链式代理增强版)
// 分流策略：
...
// 默认 false 是为了保留旧版行为；敏感场景建议改成 true。
var STRICT_NO_DIRECT_FALLBACK = false;
...
function makeUrlTestGroup(name, provider, role) {
  ...
  var timeout = isFront ? 4000 : (ENABLE_CHAIN_PROXY ? 5000 : 3000);
